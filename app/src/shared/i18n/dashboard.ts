...
export const BILLING_COPY: Record<MarketCode, BillingCopy> = {
  de: {
    ...
    subscriptionText: "299 EUR monatlich. Neue Firmen erhalten einmalig 30 Tage Testphase.",
  ...
  us: {
    ...
    subscriptionText: "299 USD monthly. New companies receive a one-time 30-day trial.",
