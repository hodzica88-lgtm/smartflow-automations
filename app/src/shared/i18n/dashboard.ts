...
export const DASHBOARD_COPY: Record<MarketCode, DashboardCopy> = {
  de: {
    ...
    overviewCopy: "Schneller Überblick über Ihre aktuellen Leads und den Weg zur Lead-Verwaltung.",
...
export const BILLING_COPY: Record<MarketCode, BillingCopy> = {
  de: {
    ...
    statusCancellationPlanned: "Kündigung geplant",
    statusCancellationDate: "Kündigungsdatum",
    yes: "Ja",
    no: "Nein",
    ...
    legalAcceptance: "Ich bestätige die AGB und die Datenschutzerklärung für die Testphase und den Checkout.",
    ...
    statusText: {
      ...
      no_subscription: "Für diese Firma ist noch kein aktives Abonnement hinterlegt.",
...
export const TEAM_COPY: Record<MarketCode, TeamCopy> = {
  de: {
    backToLeads: "Zurück zu den Leads",
    sectionLabel: "Mitarbeiter",
    title: "Zugänge verwalten",
    ...
    auditDescription: "Zeit, Benutzer und Aktion der wichtigsten Änderungen.",
    auditEmptyTitle: "Noch keine Ereignisse",
    auditEmptyMessage: "Sobald Änderungen erfolgen, erscheinen sie hier.",
  },
  us: {
