...
const COPY: Record<MarketCode, MarketCopy> = {
  de: {
    ...
    landing: {
      ...
      supporting: "Für Handwerksbetriebe und kleine Dienstleistungsunternehmen mit etwa 1 bis 20 Mitarbeitern.",
      ...
      pricingCopy: "Keine versteckten Gebühren.",
      pricingMeta: [
      ...
      faq: [
        { question: "Was ist Varnito?", answer: "Varnito ist eine schlanke Software für Betriebe mit Website-Anfragen. Sie hilft dabei, Anfragen zu sichern, zuzuordnen und im Team zu bearbeiten." },
        { question: "Ist Varnito ein CRM?", answer: "Nein. Varnito bleibt bewusst einfach und ersetzt kein klassisches CRM-System." },
        { question: "Wie funktioniert die 30-Tage-Testphase?", answer: "Sie legen ein Konto an, starten die Testphase und können Varnito 30 Tage ohne Anfangszahlung prüfen. Die erste Zahlung erfolgt erst nach dem Testende, wenn Sie aktiv weiternutzen." },
        ...
        { question: "Muss ich meine Website ersetzen?", answer: "Nein. Varnito wird neben Ihrer bestehenden Website eingesetzt und ergänzt den bestehenden Anfrageprozess." },
