...
export const DEMO_COPY: Record<DemoMarket, DemoCopy> = {
  de: {
    ...
    banner: "Demo-Modus - Änderungen werden nicht gespeichert.",
    ...
    billing: {
      ...
      active: "Aktiv",
      trial: "Testphase",
      nextInvoice: "Nächste Abrechnung",
    ...
    settings: {
      ...
      saveSimulation: "Änderungen simulieren",
    ...
    tour: {
      ...
      skip: "Überspringen",
      next: "Weiter",
      finish: "Tour abschließen",
      doneAria: "Demo Abschluss",
      steps: [
        { route: "/demo/dashboard", title: "Dashboard", text: "Hier sehen Sie Kennzahlen und offene Aufgaben. Das ist Ihre tägliche Übersicht." },
        { route: "/demo/leads", title: "Leads", text: "Alle Anfragen stehen in einer Liste. Status und Zuständigkeit sind direkt anpassbar." },
        { route: "/demo/leads/lead-de-1", title: "Lead-Details", text: "In der Detailansicht prüfen Sie alle Kontaktdaten. Notizen und Status bleiben in einem Flow." },
        { route: "/demo/team", title: "Team", text: "Laden Sie Mitarbeitende mit einer E-Mail ein. Offene und aktive Zugänge verwalten Sie hier." },
        { route: "/demo/billing", title: "Billing", text: "Abo-Status und nächste Verlängerung sind sofort sichtbar. Aktionen werden nur simuliert." },
    ...
    guide: {
      ...
      safety: "Ich helfe Ihnen ausschließlich dabei, Varnito kennenzulernen.",
    },
  },
  us: {
    nav: {
